...
SPIDMD::SPIDMD(byte panelsWide, byte panelsHigh)
  ...
  : BaseDMD(panelsWide, panelsHigh, PB1, PA10, PA9, PA8)
//  : BaseDMD(panelsWide, panelsHigh, PB1, PB12, PB13, PB2)
 #else
...
#elif defined (ARDUINO_ARCH_STM32)
  default_pins(pin_noe == PB1 && pin_a == PB12 && pin_b == PB13 && pin_sck == PB2),
#else
